                        ...
                        <div class="row">
                            <div class="col-md-12">
								...
								<%
                               	...
                               	%>
                                <form name="form" role="form" method="post" enctype="multipart/form-data" class="form-class" id="form" action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="number" value="" name="number" class="form-control" />
                                    </div>
